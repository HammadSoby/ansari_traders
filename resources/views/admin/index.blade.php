            ...
            <div class="col-md-3">
                <div class="panel bg-danger light of-h mb10">
                    <div class="pn pl20 p5">
                        ...
                        <h2 class="mt15 lh15"> <b>{{$main_categories->count()}}</b> </h2>
                        <h5 class="text-muted">Main Categories</h5>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="panel bg-alert light of-h mb10">
                    <div class="pn pl20 p5">
                        <div class="icon-bg"> <i class="fa fa-list"></i> </div>
                        <h2 class="mt15 lh15"> <b>{{$products->count()}}</b> </h2>
            ...
            <div class="col-md-3">
                <div class="panel bg-info light of-h mb10">
                    <div class="pn pl20 p5">
                        ...
                        <h2 class="mt15 lh15"> <b>{{$recipes->count()}}</b> </h2>
                        <h5 class="text-muted">Recipes</h5>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
