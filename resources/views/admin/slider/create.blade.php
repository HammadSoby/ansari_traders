                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" id="form" role="form" action="/ansari-traders/admin/add-slider" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="name" name="caption" value="{{old('caption')}}" placeholder="Enter slider caption">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <textarea class="form-control" placeholder="Type Here" name="description">{{old('description')}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
