        ...
        <header id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-trail">{{$recipe->name}} Recipe</li>
                </ol>
            </div>
        </header>
        <!-- End: Topbar -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <span class="panel-title">{{$recipe->name}} Recipe</span>
                        </div>
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" id="form" role="form" action="/ansari-traders/admin/add-recipe" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="name" name="name" value="{{$recipe->name}}" readonly placeholder="Enter recipe name">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <img src="/recipe_images/{{$recipe->image}}" width="100px" height="100px" readonly="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <textarea class="form-control" rows="15" placeholder="Type Here" name="description" readonly>{{$recipe->description}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
