        ...
        <header id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-trail">Recipes</li>
                </ol>
            </div>
        </header>
        <!-- End: Topbar -->
                    ...
                    <div class="panel panel-visible" id="spy1">
                        <div class="panel-heading">
                            <div class="panel-title hidden-xs">
                                <span class="glyphicon glyphicon-tasks"></span>Recipes</div>
                        </div>
                        <div class="panel-body pn">
                            ...
                            <a href="/ansari-traders/admin/add-recipe"><button type="button" class="btn btn-success pull-right"><span class="fa fa-plus"></span> Add Recipes</button></a>
                            <table class="table table-striped table-hover" id="datatable" cellspacing="0" width="100%">
                                ...
                                @foreach($recipes as $recipe)
                                    <tr>
                                        <td>{{$index++}}</td>
                                        <td>
                                            <img src="/recipe_images/{{$recipe->image}}" width="30px" height="30px">
                                        </td>
                                        <td>{{$recipe->name}}</td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="/ansari-traders/admin/view-recipe/{{$recipe->slug}}"><span class="fa fa-eye" title="View Recipe"></span></a>
                                            <a href="/ansari-traders/admin/edit-recipe/{{$recipe->slug}}"><span class="fa fa-edit" title="Edit Recipe"></span></a>
                                            <a href="/ansari-traders/admin/delete-recipe/{{$recipe->slug}}"><span class="fa fa-trash-o" title="Delete Recipe"></span></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
