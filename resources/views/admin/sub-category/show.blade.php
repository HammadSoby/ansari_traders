        ...
        <header id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-trail">{{$category->name}} Date</li>
                </ol>
            </div>
        </header>
        <!-- End: Topbar -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <span class="panel-title">{{$category->name}} Date</span>
                        </div>
                        <div class="panel-body">
                            <form class="form-horizontal" id="form" role="form" action="/ansari-traders/admin/add-Date-category" method="POST">
                                {{csrf_field()}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <a href="/ansari-traders/admin/date-categories"><button type="button" class="btn btn-info">Back</button></a>
                                    </div>
                                </div>
                            </form>
                        </div>
