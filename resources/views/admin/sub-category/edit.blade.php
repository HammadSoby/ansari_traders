        ...
        <header id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-trail">Edit Date Category</li>
                </ol>
            </div>
        </header>
        <!-- End: Topbar -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <span class="panel-title">Edit Date Category</span>
                        </div>
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" id="form" role="form" action="/ansari-traders/admin/edit-sub-category/{{$category->slug}}" method="POST">
                                {{csrf_field()}}
                                    ...
                                    <div class="col-lg-8">
                                        <select class="form-control" data-placeholder="---Select---" name="main_category_id">
                                            @foreach($main_categories as $main_category)
                                                <option value="{{$main_category->id}}" @if($main_category->id == $main_category->id) selected @else @endif>{{old('main_category_id') ? old('main_category_id'):$main_category->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="name" name="name" value="{{old('name') ? old('name'):$category->name}}" placeholder="Enter group name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="percentage" class="col-lg-3 control-label">Description </label>
                                    <div class="col-lg-8">
                                        <textarea class="form-control" row="40" placeholder="Type Here" name="description">{{old('description') ? old('description'):$category->description}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
