                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" id="form" role="form" action="/ansari-traders/admin/add-product" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="name" name="price" value="{{old('price')}}" placeholder="Enter price">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="name" name="weight" value="{{old('weight')}}" placeholder="Enter weight">
                                    </div>
                                </div>
