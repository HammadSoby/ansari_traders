        ...
        <header id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-trail">{{$product->subCategory->name}} {{$product->mainCategory->name}} Product</li>
                </ol>
            </div>
        </header>
        <!-- End: Topbar -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <span class="panel-title">{{$product->subCategory->name}} {{$product->mainCategory->name}} Product</span>
                        </div>
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" id="form" role="form" action="/ansari-traders/admin/add-product" method="POST" enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="name" name="price" value="{{$product->mainCategory->name}}" readonly placeholder="Enter price">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="name" name="price" value="{{$product->subCategory->name}}" readonly placeholder="Enter price">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="name" name="price" value="{{$product->price}}" readonly placeholder="Enter price">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="name" name="weight" value="{{$product->weight}}" readonly placeholder="Enter weight">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <img src="/product_images/{{$product->image}}" width="100px" height="100px" readonly="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <textarea class="form-control" row="40" placeholder="Type Here" name="description" readonly>{{$product->description}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
