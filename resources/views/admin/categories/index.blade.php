        ...
        <header id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-trail">Main Categories</li>
                </ol>
            </div>
        </header>
        <!-- End: Topbar -->
                    ...
                    <div class="panel panel-visible" id="spy1">
                        <div class="panel-heading">
                            <div class="panel-title hidden-xs">
                                <span class="glyphicon glyphicon-tasks"></span>Main Categories</div>
                        </div>
                        <div class="panel-body pn">
                            ...
                            <a href="/ansari-traders/admin/add-category"><button type="button" class="btn btn-success pull-right"><span class="fa fa-plus"></span> Add Main Category</button></a>
                            <table class="table table-striped table-hover" id="datatable" cellspacing="0" width="100%">
                                ...
                                @foreach($categories as $category)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/ansari-traders/admin/view-category/{{$category->slug}}"><span class="fa fa-eye" title="Edit Group"></span></a>
                                            <a href="/ansari-traders/admin/edit-category/{{$category->slug}}"><span class="fa fa-edit" title="Edit Group"></span></a>
                                            <a href="/ansari-traders/admin/delete-category/{{$category->slug}}"><span class="fa fa-trash-o" title="Edit Group"></span></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
