        ...
        <header id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-trail">Add Main Category</li>
                </ol>
            </div>
        </header>
        <!-- End: Topbar -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <span class="panel-title">Add Main Category</span>
                        </div>
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" id="form" role="form" action="/ansari-traders/admin/add-category" method="POST">
                                {{csrf_field()}}
