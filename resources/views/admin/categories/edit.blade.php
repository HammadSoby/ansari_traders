                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" id="form" role="form" action="/ansari-traders/admin/edit-category/{{$category->slug}}" method="POST">
                                {{csrf_field()}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <a href="/ansari-traders/admin/mango-categories"><button type="button" class="btn btn-info">Back</button></a>
                                    </div>
                                </div>
                            </form>
                        </div>
